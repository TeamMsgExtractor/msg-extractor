...
class Named:
    ...
    def __init__(self, msg):
        ...
        guids = tuple([None, Guid.GUID_PS_MAPI.value, Guid.GUID_PS_PUBLIC_STRINGS.value] + [bytesToGuid(x) for x in divide(guidStream, 16)])
        entries = []
...
class StringNamedProperty:
    def __init__(self, entry, name, data):
        ...
        if self.__guid == Guid.GUID_PS_INTERNET_HEADERS.value:
