...
class Task(MessageBase):
    ...
    def percentComplete(self) -> Optional[float]:
        ...
        """
        return self._ensureSetNamed('_percentComplete', '8102', constants.ps.PSETID_TASK)
    ...
    def taskAcceptanceState(self) -> Optional[TaskAcceptance]:
        ...
        """
        return self._ensureSetNamed('_taskAcceptanceState', '812A', constants.ps.PSETID_TASK, overrideClass = TaskAcceptance)
    ...
    def taskAccepted(self) -> bool:
        ...
        """
        return self._ensureSetNamed('_taskAccepted', '8108', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskActualEffort(self) -> Optional[int]:
        ...
        a task.
        """
        return self._ensureSetNamed('_taskActualEffort', '8110', constants.ps.PSETID_TASK)
    ...
    def taskAssigner(self) -> Optional[str]:
        ...
        """
        return self._ensureSetNamed('_taskAssigner', '8121', constants.ps.PSETID_TASK)
    ...
    def taskAssigners(self) -> Optional[bytes]:
        ...
        """
        return self._ensureSetNamed('_taskAssigners', '8117', constants.ps.PSETID_TASK)
    ...
    def taskComplete(self) -> bool:
        ...
        """
        return self._ensureSetNamed('_taskComplete', '811C', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskCustomFlags(self) -> Optional[int]:
        ...
        """
        return self._ensureSetNamed('_taskCustomFlags', '8139', constants.ps.PSETID_TASK)
    ...
    def taskDateCompleted(self) -> Optional[datetime.datetime]:
        ...
        """
        return self._ensureSetNamed('_taskDateCompleted', '810F', constants.ps.PSETID_TASK)
    ...
    def taskDeadOccurrence(self) -> bool:
        ...
        recurring task.
        """
        return self._ensureSetNamed('_taskDeadOccurrence', '8109', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskDueDate(self) -> Optional[datetime.datetime]:
        ...
        complete.
        """
        return self._ensureSetNamed('_taskDueDate', '8105', constants.ps.PSETID_TASK)
    ...
    def taskEstimatedEffort(self) -> Optional[int]:
        ...
        """
        return self._ensureSetNamed('_taskEstimatedEffort', '8111', constants.ps.PSETID_TASK)
    ...
    def taskFCreator(self) -> bool:
        ...
        request.
        """
        return self._ensureSetNamed('_taskFCreator', '811E', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskFFixOffline(self) -> bool:
        ...
        """
        return self._ensureSetNamed('taskFFixOffline', '812C', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskFRecurring(self) -> bool:
        ...
        """
        return self._ensureSetNamed('_taskFRecurring', '8126', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskGlobalID(self) -> Optional[bytes]:
        ...
        """
        return self._ensureSetNamed('_taskGlobalID', '8519', constants.ps.PSETID_COMMON)
    ...
    def taskHistory(self) -> Optional[TaskHistory]:
        ...
        """
        return self._ensureSetNamed('_taskHistory', '811A', constants.ps.PSETID_TASK, overrideClass = TaskHistory)
    ...
    def taskLastDelegate(self) -> Optional[str]:
        ...
        """
        return self._ensureSetNamed('_taskLastDelegate', '8125', constants.ps.PSETID_TASK)
    ...
    def taskLastUpdate(self) -> Optional[datetime.datetime]:
        ...
        """
        return self._ensureSetNamed('_taskLastUpdate', '8115', constants.ps.PSETID_TASK)
    ...
    def taskLastUser(self) -> Optional[str]:
        ...
        task.
        """
        return self._ensureSetNamed('_taskLastUser', '8122', constants.ps.PSETID_TASK)
    ...
    def taskMultipleRecipients(self) -> Optional[Set[TaskMultipleRecipients]]:
        ...
        """
        return self._ensureSetNamed('_taskMultipleRecipients', '8120', constants.ps.PSETID_TASK, overrideClass = TaskMultipleRecipients.fromBits)
    ...
    def taskNoCompute(self) -> Optional[bool]:
        ...
        completeness.
        """
        return self._ensureSetNamed('_taskNoCompute', '8124', constants.ps.PSETID_TASK)
    ...
    def taskOrdinal(self) -> Optional[int]:
        ...
        """
        return self._ensureSetNamed('_taskOrdinal', '8123', constants.ps.PSETID_TASK, overrideClass = unsignedToSignedInt)
    ...
    def taskOwner(self) -> Optional[str]:
        ...
        """
        return self._ensureSetNamed('_taskOwner', '811F', constants.ps.PSETID_TASK)
    ...
    def taskOwnership(self) -> Optional[TaskOwnership]:
        ...
        Contains the name of the owner of the task.
        """
        return self._ensureSetNamed('_taskOwnership', '8129', constants.ps.PSETID_TASK, overrideClass = TaskOwnership)
    ...
    def taskRecurrence(self) -> Optional[RecurrencePattern]:
        ...
        recurring tasks.
        """
        return self._ensureSetNamed('_taskRecurrence', '8116', constants.ps.PSETID_TASK, overrideClass = RecurrencePattern)
    ...
    def taskResetReminder(self) -> bool:
        ...
        """
        return self._ensureSetNamed('_taskResetReminder', '8107', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskRole(self) -> Optional[str]:
        ...
        completeness.
        """
        return self._ensureSetNamed('_taskRole', '8127', constants.ps.PSETID_TASK)
    ...
    def taskStartDate(self) -> Optional[datetime.datetime]:
        ...
        """
        return self._ensureSetNamed('_taskStartDate', '8104', constants.ps.PSETID_TASK)
    ...
    def taskState(self) -> Optional[TaskState]:
        ...
        """
        return self._ensureSetNamed('_taskState', '8113', constants.ps.PSETID_TASK, overrideClass = TaskState)
    ...
    def taskStatus(self) -> Optional[TaskStatus]:
        ...
        """
        return self._ensureSetNamed('_taskStatus', '8101', constants.ps.PSETID_TASK, overrideClass = TaskStatus)
    ...
    def taskStatusOnComplete(self) -> bool:
        ...
        """
        return self._ensureSetNamed('_taskStatusOnComplete', '8119', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskUpdates(self) -> bool:
        ...
        """
        return self._ensureSetNamed('_taskUpdates', '811B', constants.ps.PSETID_TASK, overrideClass = bool, preserveNone = False)
    ...
    def taskVersion(self) -> Optional[int]:
        ...
        """
        return self._ensureSetNamed('_taskVersion', '8112', constants.ps.PSETID_TASK)
    ...
    def teamTask(self) -> Optional[bool]:
        ...
        completeness.
        """
        return self._ensureSetNamed('_teamTask', '8103', constants.ps.PSETID_TASK)
